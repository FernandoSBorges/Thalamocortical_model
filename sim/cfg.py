...
# Saving
#------------------------------------------------------------------------------
cfg.simLabel = 'v9_batch0'       #   + str(cfg.cynradNumber)
...
# ------------------------------------------------------------------------------
cfg.analysis['plotRaster'] = {'include': cfg.S1cells, 'saveFig': True, 'showFig': False,'orderInverse': True, 'timeRange': [500,cfg.duration], 'figSize': (24,12), 'fontSize':4, 'markerSize':4, 'marker': 'o', 'dpi': 300} 
...
cfg.analysis['plotTraces'] = {'include': cfg.recordCells, 'oneFigPer': 'trace', 'overlay': True, 'timeRange': [500,cfg.duration], 'ylim': [-100,50], 'saveFig': True, 'showFig': False, 'figSize':(24,12)}
...
cfg.analysis['plotLFP'] = {'separation': 1.0, 'plots': ['timeSeries', 'spectrogram','PSD'], 'timeRange': [500,cfg.duration], 'maxFreq': 200, 'saveFig': True, 'showFig': False}
